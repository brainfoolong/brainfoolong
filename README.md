...
- [brainfoolong/cryptojs-aes-php](https://github.com/brainfoolong/cryptojs-aes-php) ([2.2.0](https://github.com/brainfoolong/cryptojs-aes-php/releases/tag/2.2.0), 5 months ago) - CryptoJS AES encryption/decryption on client side with Javascript and on server side with PHP
