...
- [brainfoolong/form-data-json](https://github.com/brainfoolong/form-data-json) ([3.0.1](https://github.com/brainfoolong/form-data-json/releases/tag/3.0.1), 2 weeks ago) - A zero dependency, cross browser library to easily get or set/manipulate form input values as/from a json object.
