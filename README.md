...
- [brainfoolong/php-svg-charts](https://github.com/brainfoolong/php-svg-charts) ([0.3.2](https://github.com/brainfoolong/php-svg-charts/releases/tag/0.3.2), 4 weeks ago) - Generate SVG image charts to be able to use it in web and pdf at the same time.
