...
- [brainfoolong/php-svg-charts](https://github.com/brainfoolong/php-svg-charts) ([0.1.0](https://github.com/brainfoolong/php-svg-charts/releases/tag/0.1.0), today) - Generate SVG image charts to be able to use it in web and pdf at the same time.
