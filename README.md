...
- [NullixAT/framelix-docker](https://github.com/NullixAT/framelix-docker) - A full featured PHP framework with built-in backend and data management capabilities. (4 weeks ago)
...
- [PHPOffice/PhpSpreadsheet](https://github.com/PHPOffice/PhpSpreadsheet) ([1.27.0](https://github.com/PHPOffice/PhpSpreadsheet/releases/tag/1.27.0), 3 days ago) - A pure PHP library for reading and writing spreadsheet files
