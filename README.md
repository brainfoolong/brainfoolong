...
- [aVadim483/fast-excel-writer](https://github.com/aVadim483/fast-excel-writer) - Lightweight and very fast XLSX Excel Spreadsheet Writer in PHP. Supports full XLSX-file functionality - cell formatting, formulas, styles, charts, etc. (2 months ago)
...
- [aVadim483/fast-excel-writer](https://github.com/aVadim483/fast-excel-writer) ([v6.9.0](https://github.com/aVadim483/fast-excel-writer/releases/tag/v6.9.0), 2 weeks ago) - Lightweight and very fast XLSX Excel Spreadsheet Writer in PHP. Supports full XLSX-file functionality - cell formatting, formulas, styles, charts, etc.
...
- [brainfoolong/php-ascon](https://github.com/brainfoolong/php-ascon) ([1.3.0](https://github.com/brainfoolong/php-ascon/releases/tag/1.3.0), 10 months ago) - PHP 8&#43; Implementation of Ascon, a family of authenticated encryption (AEAD) and hashing algorithms designed to be lightweight
- [brainfoolong/form-data-json](https://github.com/brainfoolong/form-data-json) ([3.0.0](https://github.com/brainfoolong/form-data-json/releases/tag/3.0.0), 10 months ago) - A zero dependency, cross browser library to easily get or set/manipulate form input values as/from a json object.
...
- [fixed $http_response_header php85 error](https://github.com/aVadim483/fast-excel-writer/pull/127) on [aVadim483/fast-excel-writer](https://github.com/aVadim483/fast-excel-writer) (2 months ago)
- [fixed error with mb_strtolower and null result in deprecation error](https://github.com/aVadim483/fast-excel-writer/pull/126) on [aVadim483/fast-excel-writer](https://github.com/aVadim483/fast-excel-writer) (2 months ago)
- [mb_strtolower($index) errors out with null error](https://github.com/aVadim483/fast-excel-writer/pull/125) on [aVadim483/fast-excel-writer](https://github.com/aVadim483/fast-excel-writer) (2 months ago)
- [fixed php 8.5 deprecation](https://github.com/aVadim483/fast-excel-writer/pull/124) on [aVadim483/fast-excel-writer](https://github.com/aVadim483/fast-excel-writer) (2 months ago)
...
- [Caddy Server PHP FCGI - Load Balance one upstream - Prevent 502 errors](https://gist.github.com/bd53a5484c458d746e29f87157011ef6) (1 month ago)
