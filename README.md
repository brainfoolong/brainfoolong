...
- [brainfoolong/justnocaptcha](https://github.com/brainfoolong/justnocaptcha) - User friendly, Invisible Proof of Work Captcha/Challenge for your browser without any required user interaction (5 months ago)
...
- [brainfoolong/php-svg-charts](https://github.com/brainfoolong/php-svg-charts) ([0.3.2](https://github.com/brainfoolong/php-svg-charts/releases/tag/0.3.2), 5 days ago) - Generate SVG image charts to be able to use it in web and pdf at the same time.
